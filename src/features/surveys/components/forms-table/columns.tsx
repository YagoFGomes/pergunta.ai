...
import { SURVEY_FORM_STATUS_OPTIONS, getSurveyFormStatusLabel } from './options';
...
type GetSurveyFormsColumnsConfig = {
  frameworkOptions?: Option[];
};

export function getSurveyFormsColumns({
  frameworkOptions = []
}: GetSurveyFormsColumnsConfig = {}): ColumnDef<Form>[] {
  return [
    {
      id: 'title',
      accessorKey: 'title',
